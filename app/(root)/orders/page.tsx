  ...
  return (
    <>
      ...
      <section className="wrapper mt-8">
        <Search placeholder="Buscar nombre de comprador..." />
      </section>
        ...
        <table className="w-full border-collapse border-t">
          <thead>
            <tr className="p-medium-14 border-b text-grey-500">
              <th className="min-w-[250px] py-3 text-left">Orden ID</th>
              <th className="min-w-[200px] flex-1 py-3 pr-4 text-left">Publicacion</th>
              <th className="min-w-[150px] py-3 text-left">Comprador</th>
              <th className="min-w-[100px] py-3 text-left">Creado</th>
              <th className="min-w-[100px] py-3 text-right">Precio</th>
            </tr>
          </thead>
          <tbody>
